...
class Calculator:
    ...
    def __init__(self, root):
        ...
        style.configure("TEntry", font="Serif 18", padding=10, margins=10)

        self.number_entry = ttk.Entry(root, textvariable=self.entry_value, width=45)
